...
void main() {
  /*testWidgets('SimpleCheckBoxFormField should render correctly', (WidgetTester tester) async {
    ...
    // Cria um objeto SimpleCheckBoxFormField
    SimpleCheckBoxFormField radioField = SimpleCheckBoxFormField(
      options: options,
